      ...
      <div style="font-family: sans-serif; max-width: 560px; margin: 0 auto; color: #1e293b;">
        <div style="background: linear-gradient(135deg, #7c3aed, #2563eb); padding: 32px 24px; border-radius: 12px 12px 0 0;">
          ...
          <p style="margin: 6px 0 0; color: rgba(255,255,255,0.75); font-size: 13px;">
            CUVR Spatial Systems — Booking Form
          </p>
        </div>
        ...
        <div style="background: #f8fafc; border: 1px solid #e2e8f0; border-top: none; border-radius: 0 0 12px 12px; padding: 28px 24px;">
          <table style="width: 100%; border-collapse: collapse;">
            <tr>
              <td style="padding: 10px 0; border-bottom: 1px solid #e2e8f0; font-size: 12px; font-weight: 600; text-transform: uppercase; letter-spacing: 0.08em; color: #64748b; width: 120px;">Name</td>
              <td style="padding: 10px 0; border-bottom: 1px solid #e2e8f0; font-size: 14px; color: #1e293b; font-weight: 500;">${name}</td>
            </tr>
            <tr>
              <td style="padding: 10px 0; border-bottom: 1px solid #e2e8f0; font-size: 12px; font-weight: 600; text-transform: uppercase; letter-spacing: 0.08em; color: #64748b;">Email</td>
            ...
            <tr>
              <td style="padding: 10px 0; border-bottom: 1px solid #e2e8f0; font-size: 12px; font-weight: 600; text-transform: uppercase; letter-spacing: 0.08em; color: #64748b;">Phone</td>
              <td style="padding: 10px 0; border-bottom: 1px solid #e2e8f0; font-size: 14px; color: #1e293b; font-weight: 500;">${phone || "—"}</td>
            </tr>
            <tr>
              <td style="padding: 10px 0; font-size: 12px; font-weight: 600; text-transform: uppercase; letter-spacing: 0.08em; color: #64748b;">Reason</td>
          ...
          <div style="margin-top: 24px; padding: 16px; background: #ede9fe; border-radius: 8px; border-left: 3px solid #7c3aed;">
            ...
            <p style="margin: 4px 0 0; font-size: 13px; color: #6d28d9;">
              Reply to this email or contact the patient at <a href="mailto:${email}" style="color: #7c3aed;">${email}</a> to confirm their session.
            </p>
          </div>

          <p style="margin: 20px 0 0; font-size: 11px; color: #94a3b8; text-align: center;">
            Sent via CUVR Booking System · cuvr.ae
          </p>
        </div>
      </div>
    `;
